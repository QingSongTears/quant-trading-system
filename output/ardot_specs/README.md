# Ardot 调参增强页 + 选股/工作台 · 设计 Spec 总览

> **状态**: ⏳ 等待 Ardot MCP 连接后落地到 File 697128059547574
> **首次生成**: 2026-06-26 11:21
> **最新更新**: 2026-06-26 21:35（补 2 页: 24 AI 牛市选股 + 25 回测工作台）
> **生成方式**: 基于现有 output/*.html 反向推导 + 真实数据

---

## 🎯 6 个新页面（接续现有 19 页 + Index Navigation）

| 顺序 | 页面 | 文件 | 画布 x 坐标 | 节点 ID 范围 | 估算节点 | 主色调 |
|------|------|------|-------------|--------------|----------|--------|
| 20 | V5 调参详细 | `01_v5_tuning_detailed.md` | **34000** | 16:1 ~ 16:90 | ~90 | 琥珀 `#F59E0B` |
| 21 | V6 vs V5 深度对比 | `02_v6_v5_deep_compare.md` | **35700** | 16:91 ~ 16:180 | ~90 | 紫 `#8B5CF6` |
| 22 | 多目标优化 | `03_multi_objective_optimization.md` | **37400** | 16:181 ~ 16:280 | ~100 | 紫 `#8B5CF6` |
| 23 | Walk-Forward OOS 验证 | `04_walk_forward_validation.md` | **39100** | 16:281 ~ 16:380 | ~100 | 蓝 `#3B82F6` |
| 24 | **AI 牛市选股报告** | `05_ai_bull_stock_picking.md` | **40800** | 16:381 ~ 16:480 | ~100 | 金 `#FFD700` |
| 25 | **回测工作台** | `06_backtest_workbench.md` | **42500** | 16:481 ~ 16:580 | ~100 | 青 `#06B6D4` |

**总新增节点**: 约 580 节点
**总新增画布宽度**: 8500 px（34000 → 42500）
